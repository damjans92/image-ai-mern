  ...
  const handleSubmit = async (e) => {
    ...
    if (form.prompt && form.photo) {
      ...
      try {
        ...
        console.log('EROR handle submit - ' + error)
      } finally {
        setLoading(false)
      }
    } else {
  ...
  return (
    <section className='max-w-7x1 mx-auto'>
      <div>
        ...
        <p className='Create imaginative images and visually stunning images through DALL-E AI and share them with the community'></p>
      </div>
